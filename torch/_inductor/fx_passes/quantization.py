...
def _register_quantized_cat_lowering(
    ...
    def qcat(match: Match, inputs, dim, **kwargs):
        # Refer to the implementation https://github.com/pytorch/pytorch/blob/416bf4e3e7c5f90bbc306e55501881b4f8bde981/torch/_inductor/fx_passes/post_grad.py#L234
...
def _register_quantization_cat():
    dequantize_cat_pattern = CallFunction(
        ...
        #ListOf(dequantize_per_tensor_activation_pattern, partial=True,),
        KeywordArg("dim"),
    )
