...
def register_onednn_fusion_ops():
    if torch._C._has_mkldnn:
        ...
        def mlp_linear_silu_linear_mul(
            ...
            print("w0 is: {}".format(w[0], flush=True))
            print("w1 is: {}".format(w[1], flush=True))
            print("b0 is: {}".format(b[0], flush=True))
            print("b1 is: {}".format(b[1], flush=True))
        ...
        def linear_unary(
            ...
            if attr == "mlp_silu_mul":
                return mlp_linear_silu_linear_mul(x, w, b, attr, scalars, algorithm, layout)
