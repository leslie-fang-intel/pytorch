...
class LocalBufferScope:
    ...
    def __enter__(self):
        ...
        self.exit_stack.enter_context(patch.object(V.graph.scheduler, "get_name_to_node", get_name_to_node))
        
        def get_local_buffer():
            return self.local_buffers
        self.exit_stack.enter_context(patch.object(V.graph.scheduler, "get_local_buffer", get_local_buffer))
    ...
    def add_local_buffer(self, buffer: ir.Buffer, node: SchedulerNode = None):
