...
class CppTemplateKernel(CppKernel):
    ...
    def silu_mul(self, in_buf0, in_buf1, inp0, inp1, out_buf, has_gate_bias, has_up_bias):
        ...
        return f"silu_mul_epilogue_fusion<{value_to_cpp(has_gate_bias, 'bool')}, {value_to_cpp(has_up_bias, 'bool')}>({in_ptr0}, {in_ptr1}, {inp_ptr0}, {inp_ptr1}, {out_ptr}, {M}, {N}, {in_lda}, {out_lda});"
