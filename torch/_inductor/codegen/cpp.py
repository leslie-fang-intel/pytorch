...
from .cpp_utils import cexpr, cexpr_index, DTYPE_TO_CPP, INDEX_TYPE, value_to_cpp, LocalBuffer
    ...
    def codegen_nodes(self, nodes: List[SchedulerNode], local_buffers=None):
        ...
        with LocalBufferScope(self) as scope:
            if local_buffers:
                ...
                scope.add_local_buffer(local_buffers[0].local_buf, local_buffers[0].global_node)
            def fn(node, *index_vars):
                ...
                with ctx:
                    ...
                    if op_handle:
                        ...
                        can_use_local_buf = can_use_local_buf and op_handle.can_use_local_buf
                    return res
                    ...
                    for scheduler_node in scheduler_nodes:
                        ...
                        if not scheduler_node.is_reduction() and all(
                            ...
                            local_buffer = LocalBuffer(
                                ...
                                ir.Buffer("local_buffer_data", scheduler_node.node.get_layout()),
                            )
