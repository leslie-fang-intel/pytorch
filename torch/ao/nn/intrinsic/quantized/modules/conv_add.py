...
class Conv2dAddRelu(nnq.Conv2d):
    r"""
    A Conv2dAddRelu module is a fused module of Conv2d, Add and Relu
    ...
    """
    _FLOAT_MODULE = torch.ao.nn.intrinsic.Conv2dAddRelu  # type: ignore[assignment]
    ...
    def _get_name(self):
        return 'QuantizedConv2dAddRelu'

    @classmethod
    def from_float(cls, mod):
        print("mod is: {}".format(mod))
        return super(Conv2dAddRelu, cls).from_float(mod)
