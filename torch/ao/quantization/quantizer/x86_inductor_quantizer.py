...
class X86InductorQuantizer(Quantizer):
    ...
    def _annotate_qat_conv2d_bn_binary_unary(
        ...
        for fused_partition in fused_partitions:
            ...
            binary_node = binary_partition.output_nodes[0]
            unary_node = unary_partition.output_nodes[0]
            ...
            bn_output_node_idx, extra_input_node_idx = self._get_input_idx_for_binary_node(
                bn_output_node, binary_node
            )
    ...
    def _annotate_qat_conv2d_bn_unary(
        ...
        for fused_partition in fused_partitions:
            ...
            relu_node.meta[QUANT_ANNOTATION_KEY] = _X86InductorQuantizationAnnotation(
                output_qspec=get_output_act_qspec(quantization_config),  # type: ignore[arg-type]
                _annotated=True,
                _is_output_of_quantized_pattern=True,
            )
