...
TORCH_LIBRARY(onednn, m) {
  ...
  m.def(TORCH_SELECTIVE_SCHEMA("onednn::qlinear_pointwise.binary(Tensor qx, Tensor? other, Tensor qw, Tensor? bias, float x_scale, int x_zero_point, Tensor w_scale, Tensor w_zero_point, float output_scale, int output_zero_point, ScalarType? output_dtype, float other_scale, int other_zp, str binary_post_op, float binary_alpha, str unary_post_op, Scalar?[] unary_post_op_args, str unary_post_op_algorithm) -> Tensor"));
  m.def(TORCH_SELECTIVE_SCHEMA("onednn::qlinear_pointwise.binary_tensor(Tensor qx, Tensor? other, Tensor qw, Tensor? bias, Tensor x_scale, Tensor x_zero_point, Tensor w_scale, Tensor w_zero_point, float output_scale, int output_zero_point, ScalarType? output_dtype, float other_scale, int other_zp, str binary_post_op, float binary_alpha, str unary_post_op, Scalar?[] unary_post_op_args, str unary_post_op_algorithm) -> Tensor"));
}
